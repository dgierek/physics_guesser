...
model.load_state_dict(torch.load("saved_models\\trained_on_50_simul_lr_params_0.01_20_0.9_recon_loss_only_latent_dim_10.pth"))
model.eval()  # Set to evaluation mode

# Select a sample image from the dataset
dataset = datasets.LoadedDataset(preloaded_dataset_file_name='preloaded_gravity_dataset_with_more_noise.pt')
